...
class DmsfWebdavDeleteTest < RedmineDmsf::Test::IntegrationTest
  ...
  def setup
    ...
    Setting.plugin_redmine_cmis_browser['dmsf_webdav'] = '1'
    Setting.plugin_redmine_cmis_browser['dmsf_webdav_strategy'] = 'WEBDAV_READ_WRITE'
    DmsfFile.storage_path = File.expand_path '../../fixtures/files', __FILE__
    User.current = nil    
  end
  ...
  def test_delete_when_ro
    Setting.plugin_redmine_cmis_browser['dmsf_webdav_strategy'] = 'WEBDAV_READ_ONLY'
