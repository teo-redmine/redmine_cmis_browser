    ...
    if commited_files && commited_files.is_a?(Hash)
      ...
      commited_files.each_value do |commited_file|
        ...
        unless file
          ...
          file.name = name
          file.folder = @folder
          file.notification = Setting.plugin_redmine_cmis_browser[:dmsf_default_notifications].present?          
      ...
      unless @files.empty?        
        ...
        if (@folder && @folder.notification?) || (!@folder && @project.dmsf_notification?)
          begin
            ...
            if Setting.plugin_redmine_cmis_browser[:dmsf_display_notified_recipients] == '1'
